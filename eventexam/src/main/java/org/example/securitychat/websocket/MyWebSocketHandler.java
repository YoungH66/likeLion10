...
//        session.sendMessage(new TextMessage("Echo : "+ payload));
        ...
        // 현재 인증된 사용자 정보 가져옴.
        SecurityContext springSecurityContext = (SecurityContext) session.getAttributes().get("SPRING_SECURITY_CONTEXT");
        String username = "Unknown user";
        if (springSecurityContext != null && springSecurityContext.getAuthentication() != null &&
        springSecurityContext.getAuthentication().getPrincipal() instanceof UserDetails) {
